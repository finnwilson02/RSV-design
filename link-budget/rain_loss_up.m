...
function L_rain = rain_loss_up(theta,tau)
...
%rain rate for longitude and latitude of satellite (34S, 151E) taken from
...
a = (k_h*a_h - k_v*a_v + (k_h*a_h - k_v*a_v)*cosd(theta)^2*cosd(2*tau))/(2*k);
a = 1.1;
