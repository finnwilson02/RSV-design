...
dr_0 = [-50, 0, 0]; % initial position vector in LVLH (m)
...
delta_v_planechange = commonApsePlaneChange(vB_1, vB_2, delta);
...
%% FINALLY, CALCULATE GRAVEYARD ORBIT
a_gy = a + 350e3;
e_gy = 0;
h_gy = sqrt(mu*a_gy*(1 - e_gy^2));



% Let point G be graveyard, and point F be the final point of the
% geostationary

vF_geo = h/a; % velocity at F of geo (m/s)

[delta_vs_graveyard, hohmann_graveyard] = coplanarHohmann(a, e, a_gy, e_gy, 0, 0, 0);
